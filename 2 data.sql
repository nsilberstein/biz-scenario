...
union select 'Mendy', 'Weiss', 'Violin', 'String', 40,  '2019-06-07','2020-02-16'
...
union select 'Shmuli', 'David', 'Piano', 'Percussion', 65,'2019-03-19','2019-08-15'
union select 'Baila', 'Weitz', 'Trumpet', 'Wind', 53,'2020-05-03','2020-12-29'
union select 'Hadassah', 'Gruber', 'Guitar', 'String', 42,'2020-01-03','2020-09-29'
union select 'Rivkala', 'Scheiner', 'Violin', 'String', 40,'2021-05-24','2022-01-01'
union select 'Chaya Faiga', 'Rothstein', 'Clarinet', 'Wind', 35,'2020-09-28','2020-11-16'
