...
create table dbo.Rental (
    ...
    --constraint ck_rental_Date_Returned_is_greater_than_a_month_and_less_then_a_year check(datepart(month, DateRented) between datepart(month, DateReturned) between 1 and 12)
)
